<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="name" type="text" class="mt-1 block w-full dark:bg-white dark:text-black  bg-white text-black focus:border-orange-500 dark:focus:border-orange-500 focus:ring-orange-500 dark:focus:ring-orange-600" wire:model="state.name" required autocomplete="name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="email" type="email" class="mt-1 block w-full dark:bg-white dark:text-black bg-white text-black focus:border-orange-500 dark:focus:border-orange-500 focus:ring-orange-500 dark:focus:ring-orange-600" wire:model="state.email" required autocomplete="username" />
