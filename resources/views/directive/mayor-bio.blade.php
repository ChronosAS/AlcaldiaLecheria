<x-main-layout class="dark:bg-slate-300">
    ...
    <div class="my-8 mt-0 space-y-4 px-4 mx-auto max-w-7xl">
        <x-full-card>
                ...
                <div class="text-xl">
                    <h1>10.° Alcalde del Municipio Diego
                    Bautista Urbaneja</h1>
                    <div class="flex items-center justify-center">
                    <img src="{{asset('assets/img/manuel-ferreira.jpg')}}" class="h-[30rem] m-4 transition duration-300 ease-in-out hover:shadow-lg ">
                    </div>
                ...
                <x-slot name="content">
                    <div class="font-serif m-5 text-justify tracking-wide space-y-2 text-lg">
                        <p>
                        Manuel Ferreira (Lechería, Venezuela, 30 de noviembre de 1979) es un abogado y político venezolano. Actualmente es alcalde del municipio Diego Bautista Urbaneja, del estado Anzoátegui. Fue electo el 10 de diciembre de 2017.<br>
                        ...
                        <br>
                        <p>
                            Nació el 30 de noviembre de 1979 en la ciudad de Lechería, Anzoátegui.<br>
                            Se tituló como abogado en la Universidad Santa María, Núcleo Oriente (2001), en donde realizó un postgrado en penal y criminalística (2015).<br>
                            Junto a varios juristas del Estado Anzoátegui, creó la fundación Estamos Para Asistirte, promoviendo y defendiendo los derechos de los venezolanos, las leyes y la constitución venezolana.<br>
                        ...
                        <br>
                        <p>
                        Es profesor de la Facultad de Derecho de la Universidad Santa María, Núcleo Oriente, donde enseña múltiples cátedras.<br>
