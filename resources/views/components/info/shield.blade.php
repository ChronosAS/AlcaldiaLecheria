<div class="my-8 mt-0 space-y-4 px-4 mx-auto max-w-7xl">
    <x-full-card>
        ...
        <div class="text-xl">
            ...
            <img src="{{asset('assets/img/Escudo.png')}}" class="h-[15rem] transition duration-300 ease-in-out hover:shadow-lg dark:hover:shadow-black/30 rounded-full ">
            </div>
...
Como ornamentos exteriores, el blasón muestra un ancla en Plata acolada (puesta detrás) al Escudo y un anillo en Plata (blanco) con borduras (bordes) en Azur (azul) que contiene las inscripciones: <b class="text-md">“MUNICIPIO TURÍSTICO EL MORRO LICENCIADO DIEGO BAUTISTA URBANEJA”</b> en la parte superior y “1953 <b class="text-md">– LECHERÎA –</b>1992” en la parte inferior, realizadas en letras góticas capitales de Oro y separados entre sí mediante viñetas circulares del mismo metal (anexo 1, figura 2).<br>
<p>
...
<p>
<b class="text-xl">- Semiología:</b><br>
