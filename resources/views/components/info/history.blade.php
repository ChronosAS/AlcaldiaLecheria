        ...
        <x-slot name="content">
            <div class="font-serif m-5 space-y-8">
                <div>
                    ...
                    <div class="bg-blue-50/70 rounded-xl p-6 shadow-inner text-justify leading-loose space-y-4 text-lg text-gray-800">
                        <p>
                ...
                <div>
                    <h2 class="font-bold text-2xl text-blue-800 mb-4 flex items-center gap-2">
                        ...
                        Efemérides de Lechería
                    </h2>
                    <ul class="list-inside list-disc p-6 bg-blue-50/70 rounded-xl shadow-inner tracking-wide leading-relaxed space-y-4 text-justify text-lg">
                        <li>
                        ...
                        <li>
                            <b class="text-blue-700"><u>12 de Agosto de 1954:</u></b> El Concejo del actual Municipio Bolívar del Estado Anzoátegui y Víctor Morino firma un contrato mediante el cual posteriormente se se inició la construcción de la Plaza Bolívar de Lechería y la Casa Municipal.
                        </li>
                        <li>
