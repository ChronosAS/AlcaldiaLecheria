<div>
    <div class="bg-slate-300 py-6 sm:py-8 lg:py-12">
        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div class="grid grid-cols-1 r gap-4 my-8 sm:grid-cols-2 flex-wrap flex-col">
                    <!-- image - start -->
                    <a href=""
                        class=" relative flex  h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 flex-wrap flex-col">
                        <!-- image - start -->
                    <a href="#"
                        class=" relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg  md:h-80">
