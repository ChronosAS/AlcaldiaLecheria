    ...
    <x-dialog-modal maxWidth="md" wire:model="galleryModal" transparent="true">
        ...
        <x-slot name="content">
            ...
            <div x-data="{
                ...
                <!-- previous button -->
                <button type="button" class="absolute left-5 top-1/2 z-20 flex rounded-full -translate-y-1/2 items-center justify-center bg-white/40 ml-2 p-2 text-slate-700 transition hover:bg-white/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  active:outline-offset-0  dark:text-slate-300  " aria-label="previous slide" x-on:click="previous()">
                ...
                <!-- next button -->
                <button type="button" class="absolute right-5 top-1/2 z-20 flex rounded-full -translate-y-1/2 items-center justify-center bg-white/40 mr-2 p-2 text-slate-700 transition hover:bg-white/60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2  active:outline-offset-0  dark:text-slate-300  " aria-label="next slide" x-on:click="next()">
