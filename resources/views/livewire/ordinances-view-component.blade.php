            ...
            <aside id="separator-sidebar" class=" col-span-2 row-span-5" aria-label="Sidebar">
               <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-blue-800">
                  <ul class="space-y-2 font-medium">
                     <li>
                        <a href="#" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-orange-500 group">
                     ...
                     <li>
                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-orange-500 group">
                           ...
                           <span class=" ms-3 whitespace-nowrap">Kanban</span>
                     ...
                     <li>
                        <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-orange-500  group">
                           ...
                           <span class=" ms-3 whitespace-nowrap">Inbox</span>
                  ...
                  <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                     <li>
                        <a href="#" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-orange-500  dark:text-white group">
