<div>
    ...
    <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white ">
        <div class="justify-between px-4  rounded-xl ">
            <article class="mx-auto mb-10 w-full max-w-[45rem] format format-sm sm:format-base lg:format-lg format-blue ">
                    ...
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 ">
                            <div>
                                ...
                                <p class="text-base text-blue-400 ">Autor: {{ $post->user->name }}</p>
                                <p class="text-base text-blue-400 ">{{ $post->iso_date }}</p>
                            </div>
                        </div>
                    </address>
