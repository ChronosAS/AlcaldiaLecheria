<div>
    ...
    <div class=" flex sm:grid sm:grid-cols-10 sm:grid-rows-6 gap-4">
                ...
                <x-slot name="content" class="">
                    ...
                    <ul class="grid grid-cols-1 xl:grid-cols-3 gap-y-10 gap-x-6 items-start p-8">
                        ...
                        <li class="relative flex flex-col sm:flex-row xl:flex-col items-start">
                            ...
                            <img src="g" alt="" class="mb-6 shadow-md rounded-lg bg-slate-50 w-full sm:w-[17rem] sm:mb-0 xl:mb-6 xl:w-full" width="1216" height="640">
                        </li>
                        <li class="relative flex flex-col sm:flex-row xl:flex-col items-start">
                            <div class="order-1 sm:ml-6 xl:ml-0">
                                <h3 class="mb-1 text-slate-900 font-semibold">
        ...
        <x-twitter-feed class="col-span-2 row-span-6 col-start-9  sticky hidden sm:inline-block"/>
    </div>    
</div>
