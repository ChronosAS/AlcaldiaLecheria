<div>
    ...
    <div class=" flex sm:grid sm:grid-cols-10 sm:grid-rows-6 gap-4">
        ...
        <div wire:ignore class="col-span-2 row-span-6 col-start-9 sm:w-[10rem] md:scale-50 transform-none lg:transform-none md:w-[11rem] lg:w-[15rem] xl:w-[25rem] right-10 justify-self-center fixed hidden sm:inline-block">
