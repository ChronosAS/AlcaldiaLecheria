<div>
    ...
    <div class=" flex sm:grid sm:grid-cols-10 sm:grid-rows-6 gap-4">
        ...
        <div wire:ignore class="row-start-1 col-start-9    xl:scale-[.7] md:scale-[.7] 2xl:scale-100   xl:w-[18rem]  2xl:w-[25rem] overscroll-y-contain 2xl:bottom-auto xl:bottom-8 xl:right-4 2xl:right-10 justify-self-center fixed hidden sm:inline-block">
