<div>
    ...
    <div class=" flex sm:grid sm:grid-cols-10 sm:grid-rows-6 gap-4">
        ...
        <div wire:ignore class="row-start-1 col-start-9    xl:scale-[.8] md:scale-[.7] 2xl:scale-100   xl:w-[14rem]  2xl:w-[25rem] overscroll-y-contain 2xl:bottom-auto xl:bottom-[.80rem] right-10 justify-self-center fixed hidden sm:inline-block">
