<div>
    ...
    <div class=" flex sm:grid sm:grid-cols-10 sm:grid-rows-6 gap-4">
        ...
        <div wire:ignore class="col-span-2 row-span-6 col-start-9    xl:-scale-50 2xl:scale-100 transform-none xl:transform-none  xl:w-[14rem]  2xl:w-[25rem] mb-2 overscroll-y-contain right-10 justify-self-center fixed hidden sm:inline-block">
