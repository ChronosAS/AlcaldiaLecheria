<x-main-layout class="bg-blue-700">
    <div x-data="{ title: 'Carta de Soltería' }">
            ...
            <x-full-card>
                ...
                <x-slot name="content" class="center">
                    <div x-data="{ selectedTab: 'requirements' }" class="max-w-xl mt-4 px-4 mx-auto">
                        ...
                        <div class="px-2 py-6 text-slate-700 min-h-[100px] bg-white/90 rounded-b-xl shadow-lg transition-all duration-500">
                            <div
                            ...
                            >
                                <ul class="max-w-xl text-lg font-black text-blue-900 bg-white border border-blue-200 rounded-lg shadow">
                                    <li class="w-full px-4 py-4 border-b border-blue-300 rounded-t-lg">
                                        Las constancias de soltería se realizan en el Registro Civil en la Av. Anzoátegui con Calle Los Almendrones, Quinta Araguaney, Diagonal a la Plaza “El Parque”.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                        ...
                        <a
                            href="{{ asset('assets/docs/civil-registry/constancia-de-solteria.pdf') }}" target="_blank"
