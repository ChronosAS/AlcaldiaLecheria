            ...
            <x-full-card>
                ...
                <x-slot name="subTitle">
                    <div class="text-xl">
                        ...
                        <img src="{{asset('assets/img/civil-registry/registry-info/carta-de-solteria.webp')}}" class="h-[7rem] m-4 transition duration-300 ease-in-out hover:shadow-lg ">
                        </div>
                    </div>
                </x-slot>
