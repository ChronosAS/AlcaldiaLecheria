            ...
            <x-full-card class="">
               ...
               <x-slot name="content" class="center">
                    ...
                    <div class="flex  flex-row items-center justify-center space-x-5 ">
                        ...
                        <a  href="{{ asset('assets/docs/civil-registry/fe-de-vida.pdf') }}" target="_blank" class=" cursor-pointer whitespace-nowrap rounded-xl bg-green-700 px-4 py-2 text-lg font-medium tracking-wide text-slate-100 transition hover:opacity-75 text-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700 active:opacity-100 active:outline-offset-0 disabled:opacity-75 disabled:cursor-not-allowed  ">Descargar Planilla</a>
                    </div>
                </x-slot>
            </x-full-card>
        </div>
