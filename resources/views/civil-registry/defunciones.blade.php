            ...
            <x-full-card>
                ...
                <x-slot name="subTitle">
                    <div class="text-xl">
                        ...
                        <img src="{{asset('assets/img/civil-registry/registry-info/defuncion.webp')}}" class="min-h-[15rem] max-h-[18rem] min-w-[30rem] max-w-[35rem] m-4 transition duration-300 ease-in-out hover:shadow-lg rounded-lg">
                        </div>
                    </div>
                </x-slot>
