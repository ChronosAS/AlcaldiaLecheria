                        ...
                        <div class="px-2 py-4 text-black ">
                            ...
                            <div x-show="selectedTab === 'weekend'" id="tabpaneWeekend" role="tabpanel" aria-label="weekend" class="text-center">
                                <ul class="max-w-3xl text-md font-medium  text-black bg-white border border-blue-200 rounded-lg">
                                    ...
                                    <li class="w-full px-4 py-2 border-b border-blue-300 rounded-t-lg "> Teléfono de Guardia </li>
                                    <li class="w-full px-4 py-2 border-b border-blue-300 rounded-t-lg "> 04162830854 </li>
                                </ul>
                            </div>
