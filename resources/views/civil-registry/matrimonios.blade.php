        ...
        <div class="my-10  space-y-4 px-4 mx-auto max-w-5xl">
            <x-full-card>
                ...
                <x-slot name="content" class="center">
                    <div x-data="{ selectedTab: 'requirements' }" class="max-w-2xl mt-4 px-4 mx-auto">
                        <div @keydown.right.prevent="$focus.wrap().next()" @keydown.left.prevent="$focus.wrap().previous()" class="flex gap-2 overflow-x-auto border-b border-slate-300 sm:justify-evenly " role="tablist" aria-label="tab options">
