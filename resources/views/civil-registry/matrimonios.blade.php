                ...
                <x-slot name="content" class="center">
                    <div x-data="{ selectedTab: 'requirements' }" class="max-w-3xl mt-4 px-4 mx-auto">
                        ...
                        <div class="px-2 py-6 text-slate-700 min-h-[120px] bg-white/90 rounded-b-xl shadow-lg transition-all duration-500">
                            <div x-show="selectedTab === 'requirements'"
                                ...
                                <ul class="max-w-3xl text-md font-medium text-black bg-white border border-blue-200 rounded-lg shadow space-y-0">
                                    <li class="w-full px-4 py-2 border-b border-blue-300 rounded-t-lg transition-all duration-200 hover:bg-blue-50">
                                        1.- Imprimir y llenar el Formato (En Letra Molde Legible) después que tome la Cita.  
                                        <br> 
                                    ...
                                    <li class="w-full px-4 py-2 border-b border-blue-300 transition-all duration-200 hover:bg-blue-50">
                                        5.- Cartas de soltería de ambos contrayentes.<br/>
                                        <a href="{{ asset('assets/docs/civil-registry/carta-de-solteria.pdf') }}" target="_blank" class="cursor-pointer text-blue-700 hover:text-blue-500">Descargar </a>
                                    </li>
                                    <li class="w-full px-4 py-2 border-b border-blue-300 transition-all duration-200 hover:bg-blue-50">
                                        6.- Descargar e Imprimir el Acta de Esponsalicia.<br/>
                                        <a href="{{ asset('assets/docs/civil-registry/acta-eponsalicia.pdf') }}" target="_blank" class="cursor-pointer text-blue-700 hover:text-blue-500">Descargar </a>
                                    </li>
                                    <li class="w-full px-4 py-2 border-b border-blue-300 transition-all duration-200 hover:bg-blue-50">
                                        7.- Copias de las Cédulas de Identidad de dos testigos, mayores de 21 años de edad, venezolanos. (No pueden ser los padres)
                                    </li>
                                </ul>
                            </div>
